...
export default function Forgotpassword() {
  return (
    <div className='w-full h-auto flex justify-center items-center bg-gray-200'>
      ...
      <input type="email" placeholder='email address' className='w-full h-10 rounded-lg border-2 border-black px-3.5 mt-4' />
      <button className='w-full h-10 rounded-lg bg-black text-white font-bold text-md mt-5'>Reset pasword</button>
